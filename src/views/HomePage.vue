<template>
  <div class="mx-5 my-3">
    ...
    <p class="text-justify">
      ...
      nuklir, yaitu sinar gamma dan sinar-X.
      <br />
      Dengan teknisi ahli dari GamMAX, kami selalu mengusahakan pelayanan
      terbaik dengan harga yang bersaing bagi semua pelanggan. Kami sangat
      mengutamakan aspek proteksi radiasi, keselamatan kerja, dan pelayanan
      yang berkualitas.
    </p>
    <br />
